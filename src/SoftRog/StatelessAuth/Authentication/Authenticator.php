...
class Authenticator implements ContainerAwareInterface
{
  ...
  {
    if (!$this->keyGetter instanceof \SoftRog\StatelessAuth\AccessKeyGetter\AccessKeyGetterInterface) {
      throw new \SoftRog\StatelessAuth\AccessKeyGetter\Exception\InvalidAccessKeyGetterException();
    }
